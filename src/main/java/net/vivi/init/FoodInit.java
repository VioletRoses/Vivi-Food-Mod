...
public class FoodInit {
    ...
    public static final Item CHICKEN_SALAD = new Item(new Item.Settings().group(ItemGroup.FOOD).food(new FoodComponent.Builder().hunger(12).saturationModifier(15.0f).meat().build()));
    public static final Item RAW_BACON = new Item(new Item.Settings().group(ItemGroup.FOOD).food(new FoodComponent.Builder().hunger(4).saturationModifier(2.0f).meat().build()));
    public static final Item COOKED_BACON = new Item(new Item.Settings().group(ItemGroup.FOOD).food(new FoodComponent.Builder().hunger(10).saturationModifier(14f).meat().build()));
